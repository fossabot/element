...
const components = [Dialog, Button, ButtonGroup, Table, TableColumn, Form, FormItem, Input, Select, Option, Radio, RadioGroup, RadioButton, Menu, SubMenu, MenuItem, MenuItemGroup, Container, Aside, Main, Footer, Header, Row, Col, Forms, Upload]
